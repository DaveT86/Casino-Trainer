document.getElementById('roulette-button').addEventListener('click', function() {
    window.location.href = 'roulette/roulette.html'; // Redirect to Roulette page
});

document.getElementById('blackjack-button').addEventListener('click', function() {
    window.location.href = 'blackjack.html'; // Redirect to Blackjack page
});
